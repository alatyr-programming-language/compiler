...
## semantic checking must reject this before backend-specific lowering, so no silent capture loss
## occurs. (A NON-capturing lambda / a named top-level fn IS a valid fn value — see
