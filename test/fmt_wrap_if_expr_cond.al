## e2e — §4.3.3, the 100-column rule, for the one construct whose overflow its own sub-construct
...
## missed by exactly the width of the arms. The condition here is a five-term `and` chain: §4.3.3's
